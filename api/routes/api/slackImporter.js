...
slackRouter.get('/', (req: any, res: any) => {
  ...
  const returnURI = IS_PROD
    ...
    : 'https://beta.weirdstreet.com:3001/api/slack';
  ...
  return generateOAuthToken(code, returnURI)
    ...
    .then(slug => {
      return IS_PROD
        ? res.redirect(`https://beta.weirdstreet.com/${slug}/settings`)
        : res.redirect(`https://beta.weirdstreet.com:3000/${slug}/settings`);
    });
});
...
slackRouter.get('/onboarding', (req: any, res: any) => {
  ...
  const returnURI = IS_PROD
    ...
    : 'https://beta.weirdstreet.com:3001/api/slack/onboarding';
  ...
  return generateOAuthToken(code, returnURI)
    ...
    .then(id => {
      return IS_PROD
        ...
        : res.redirect(`https://beta.weirdstreet.com:3000/new/community?s=2&id=${id}`);
    });
});
