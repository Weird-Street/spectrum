...
const communityBeforeUrlIsValid = () =>
  cy.url().should('eq', 'https://beta.weirdstreet.com:3000/spectrum?tab=posts');
const channelBeforeUrlIsValid = () =>
  cy.url().should('eq', 'https://beta.weirdstreet.com:3000/spectrum/general?tab=posts');
...
describe.skip('thread modal route', () => {
  ...
  it('handles esc key', () => {
    ...
    cy.url(
      'eq',
      'https://beta.weirdstreet.com:3000/spectrum/private/yet-another-thread~thread-6'
    );
  ...
  it('handles channel feed', () => {
    ...
    cy.url(
      'eq',
      'https://beta.weirdstreet.com:3000/spectrum/spectrum/general/yet-another-thread~thread-9'
    );
