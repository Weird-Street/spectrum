...
const communityBeforeUrlIsValid = () =>
  cy.url().should('eq', 'https://beta.weirdstreet.com/spectrum?tab=posts');
const channelBeforeUrlIsValid = () =>
  cy.url().should('eq', 'https://beta.weirdstreet.com/spectrum/general?tab=posts');
...
describe.skip('thread modal route', () => {
  ...
  it('handles esc key', () => {
    ...
    cy.url(
      'eq',
      'https://beta.weirdstreet.com/spectrum/private/yet-another-thread~thread-6'
    );
  ...
  it('handles channel feed', () => {
    ...
    cy.url(
      'eq',
      'https://beta.weirdstreet.com/spectrum/spectrum/general/yet-another-thread~thread-9'
    );
