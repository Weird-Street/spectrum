...
const Share = ({ community, onboarding }) => {
  ...
  return (
    <div>
      <ButtonRow>
        <FacebookButton
          href={`https://www.facebook.com/sharer/sharer.php?u=https://beta.weirdstreet.com/${encodeURIComponent(
            community.slug
        ...
        <TwitterButton
          href={`https://twitter.com/share?text=Come hang out with me in the ${
            community.name
          } community on @withspectrum!&url=https://beta.weirdstreet.com/${encodeURIComponent(
            community.slug
          )}`}
        >
          Share on Twitter
      ...
      <Clipboard
        component="div"
        data-clipboard-text={`https://beta.weirdstreet.com/${community.slug}`}
      >
        <InputRow>
          <Input>{`https://beta.weirdstreet.com/${community.slug}`}</Input>
        </InputRow>
      </Clipboard>
