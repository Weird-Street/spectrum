...
module.exports = {
  ...
  APP_REMOTE_URL: 'https://beta.weirdstreet.com/login',
  APP_DEV_URL: 'https://beta.weirdstreet.com:3000/login',
  APP_REMOTE_HOME_URL: 'https://beta.weirdstreet.com',
  APP_DEV_HOME_URL: 'https://beta.weirdstreet.com:3000',
